...
String projectsCommonFile = readFileFromWorkspace('Jenkins/Snapshot_install_Jobs')
...
def createPipelineBuildJob(project_name) {
    pipelineJob(project_name) {
        description ('ENM Cloud Native Snapshot Install build pipeline ' + project_name + ' - autogenerated using JobDSL - all manual changes will be overwritten!')
