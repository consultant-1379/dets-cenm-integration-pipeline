...
String projectsCommonFile = readFileFromWorkspace('Jenkins/MTE_Restore_Jobs')
...
def createPipelineBuildJob(project_name) {
    pipelineJob(project_name) {
        description ('ENM Cloud Native Restore  Build pipeline ' + project_name + ' - autogenerated using JobDSL - all manual changes will be overwritten!')
        ...
        definition {
            cpsScm {
                ...
                scriptPath("Jenkins/Jenkinsfile/JenkinsfileRestore")
