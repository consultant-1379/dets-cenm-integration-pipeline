...
String projectsCommonFile = readFileFromWorkspace('Jenkins/MTE_snapshot_integration_install_Jobs')
...
def createPipelineBuildJob(project_name) {
    pipelineJob(project_name) {
        description ('ENM Cloud Native Initial_Install Build pipeline ' + project_name + ' - autogenerated using JobDSL - all manual changes will be overwritten!')
