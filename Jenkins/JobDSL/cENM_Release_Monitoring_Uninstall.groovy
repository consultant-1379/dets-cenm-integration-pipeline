...
String projectsCommonFile = readFileFromWorkspace('Jenkins/MTE_Monitoring_Uninstall_Jobs')
...
def createPipelineBuildJob(project_name) {
    pipelineJob(project_name) {
        description ('Monitoring UnInstall pipeline ' + project_name + ' - autogenerated using JobDSL - all manual changes will be overwritten!')
        ...
        definition {
            cpsScm {
                ...
                scriptPath("Jenkins/Jenkinsfile/JenkinsfileMonitoringUninstall")
